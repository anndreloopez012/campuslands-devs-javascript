...
["Ferrari", "Lamborghini", "Bugatti"].forEach(m => modelo.add(new Option(m, m)));
const velocidad = Object.assign(document.createElement("input"), { type: "range", min: 0, max: 350, value: 120 });
const color = Object.assign(document.createElement("input"), { type: "color", value: "#1463ff" });
...
[modelo, velocidad, color].forEach(el => el.addEventListener("input", actualizar));
