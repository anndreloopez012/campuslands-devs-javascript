...
async function iniciar() {
    try {
        ...
        console.log(`Listo: ${heroe.nombre} | ${heroe.clase} Nv.${heroe.nivel} | HP ${heroe.hp}`);
        console.log(heroe.nivel >= 5 ? "Personaje apto para la mazmorra." : "Sube de nivel antes de entrar.");
    } catch (error) {
        console.log(error);
    }
}
