...
```bash
docker pull ghcr.io/anndreloopez012/campuslands-devs-javascript:dev
docker run --rm -p 8080:80 ghcr.io/anndreloopez012/campuslands-devs-javascript:dev
```
...
- `dev` publica la etiqueta `ghcr.io/anndreloopez012/campuslands-devs-javascript:dev`.
- `main` publica la etiqueta `ghcr.io/anndreloopez012/campuslands-devs-javascript:latest`.
